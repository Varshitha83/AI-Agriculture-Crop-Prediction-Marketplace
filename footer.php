 <footer class="footer">
   	...
   	<script src="https://code.jquery.com/jquery-3.3.1.min.js" integrity="sha384-tsQFqpERiu3a6z1YdG+BU6G1pL6x6hF9Ijq1zjm0rDO9H9W7jv4R82G2/tQf42kQ" crossorigin="anonymous"></script>

	<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.12.1/js/jquery.dataTables.js"></script>

	<script src="../assets/js/state_district_crops_dropdown.js"></script>
	<script src="../assets/js/TradeCrops.js"></script>
