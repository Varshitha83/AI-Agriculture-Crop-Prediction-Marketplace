<footer class="footer">
  <div class="container">
    <div class="row">
      ...
      <!-- Address + Call / Fax / Email buttons -->
      <div class="offset-sm-2 col-5">
        ...
        <address>
          ...
          <div class="btn-group text-center mt-2" role="group">
            <!-- CALL -->
            <a role="button" class="btn btn-primary" href="tel:+919391260913">
              <i class="fa fa-phone"></i> Call
            </a>

            <!-- FAX (same number, you can change if needed) -->
            <a role="button" class="btn btn-info" href="tel:+919391260913">
              <i class="fa fa-fax"></i> Fax
            </a>

            <!-- EMAIL – FIXED: uses mailto: -->
            <a role="button" class="btn btn-success" href="mailto:santhoshamsricharan28@gmail.com">
      ...
      <div class="col-12 col-md-3 align-self-center">
        <div class="social-network text-center">
          <a target="_blank" href="/" rel="nofollow"
             class="btn btn-icon-only btn-linkedin rounded-circle"
             data-toggle="tooltip" data-original-title="Mail Us">
