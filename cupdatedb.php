...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $utr = isset($_POST['utr']) ? $_POST['utr'] : '';
    $payment_method = isset($_POST['payment_method']) ? $_POST['payment_method'] : '';

    if (empty($amount) || empty($utr)) {
        echo "<script>alert('Invalid payment details'); window.location.href='cbuy_crops.php';</script>";
        exit();
    }
    ...
    $query = "INSERT INTO payments (amount, payment_method, utr) VALUES ('$amount', '$payment_method', '$utr')";
