...
<head>
  ...
  <section class="section section-lg" style="background-image: url('../assets/img/admin_login.jpg'); background-size: cover; background-position: center; background-attachment: fixed; position: relative; min-height: 700px;">
