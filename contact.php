...
<head>
  ...
  <title><?php echo isset($SITE_NAME) ? $SITE_NAME : 'Agriculture portal'; ?></title>
...
<body class="bg-white" id="top">
          ...
          <li class="nav-item">
            <a href="contact.php" class="nav-link">
              <span class="text-success nav-link-inner--text">
                <i class="text-success fas fa-address-card"></i> Contact
              </span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <div class="dropdown show">
              <a class="nav-link dropdown-toggle text-white" href="#" role="button"
                 id="dropdownSignUp" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  ...
  <section class="section section-lg" style="background-image: url('assets/img/hero.jpeg'); background-size: cover; background-position: center; background-attachment: fixed; position: relative; min-height: 900px;">
    <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(0, 0, 0, 0.4);"></div>

    <div class="text-gray-100" style="position: relative; z-index: 1;">
      <!-- IMPORTANT: this posts to contact-script.php -->
      <form action="contact-script.php" method="post">
        <div class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32
                    py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          <div class="flex flex-col justify-between">
            ...
            <div class="mt-2">
              ...
              <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg
                             focus:outline-none focus:shadow-outline"
                     type="tel" id="user_mobile" name="user_mobile"
                     pattern="^[6-9]{1}[0-9]{9}$"
                     title="Enter Valid 10 digit Mobile Number (Ex. 9876543210)"
          ...
          <div class="flex flex-col justify-between">
            <div class="mt-2">
              ...
              <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg
                     ...
                     title="Enter your City Name and Pincode"
                     placeholder="Enter your City/Pincode">
            </div>

            <div class="mt-2">
              <span class="uppercase text-sm text-gray-600 font-bold">Message</span>
              <textarea class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-7 rounded-lg
                               focus:outline-none focus:shadow-outline"
                        rows="8" id="user_message" name="user_message"
                        title="Enter your Issue in Detail"
                        placeholder="Enter your Issue" required></textarea>
            </div>

            <div class="mt-2">
              <button class="uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100
                             p-3 rounded-lg w-full focus:outline-none focus:shadow-outline"
    ...
    <!-- SUCCESS MODAL -->
    <div class="modal fade" id="mysuccessModal" data-backdrop="static">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <h6>You are very important to us, all information received will always remain confidential.
                We will contact you as soon as we review your message.</h6>
          </div>
    ...
    <!-- ERROR MODAL -->
    <div class="modal fade" id="myunsuccessModal" data-backdrop="static">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header" style="background-color:#1A4E85;color:white;">
            <h4 class="modal-title">Message</h4>
