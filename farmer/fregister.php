...
function getdistrict(val) {
  ...
  <section class="section section-lg" style="background-image: url('../assets/img/far_register.jpeg'); background-size: cover; background-position: center; background-attachment: fixed; position: relative; min-height: 900px;">
    <div style="position:absolute; top:0; left:0; right:0; bottom:0; background-color: rgba(0,0,0,0.4);"></div>

    <div class="shape shape-style-1 shape-primary" style="display:none;">
      <span></span>
      <span></span>
      <span></span>
      <span></span>
...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-info" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Farmer Sign up</a>
 ...
 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
		              Cmr Technical Campus, Kandlakoya<br>
		              Medchal - 501 401, Telangana<br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+919391260913"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+919391260913"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="mailto:santhoshamsricharan28@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
