...
<head>
  ...
  <section class="section section-lg" style="background-image: url('../assets/img/far_register.jpeg'); background-size: cover; background-position: center; background-attachment: fixed; position: relative; min-height: 600px;">
