...
function getdistrict(val) {
  ...
  <section class="section section-lg" style="background-image: url('../assets/img/cust_login.png'); background-size: cover; background-position: center; background-attachment: fixed; position: relative; min-height: 900px;">
...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-info" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">User Signup</a>
